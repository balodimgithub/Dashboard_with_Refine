...
//define the font size and the line heights
const sizes = {
    xs: {
        fontSizes : 12,
        lineHeight : 20/12,
...
{/** 
    ...
    Typography has different components like Title, Paragraph,
    Text, Link e.t.c
     https://antd.docs/components/typography/#Typography.Text
     */}
